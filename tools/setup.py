...
def main():
    ...
    print("""
  ######################################
  # RWYL Development Environment Setup #
  ######################################

  This script will create your RWYL dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your RWYL project folder:
    [Arma 3 installation directory]\\{} => RWYL project folder
    P:\\{}                              => RWYL project folder
